...
//			configOBj.fieldId=fieldId;
		...
		var objEvt = new Object();
			objEvt.ok = function(bnd:Object){
				...
				var dp=tmp.fields_dg.dataProvider;
				dp[dg_index].ent_att= codSelected;
				dp[dg_index].ent_att_name= descSelected;
				tmp.fields_dg.dataProvider=dp;
				tmp.fields_dg.redraw(true);
				popUp.deletePopUp();
			}
