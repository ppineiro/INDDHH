...
class com.st.formDesigner.view.ToolBar extends MovieClip{
	...
	var href_btn:MovieClip;
	var textFormat_btn:MovieClip;
	...
	function ToolBar(Void){
		...
		var lblToolHref = _global.labelVars.lblToolHref;
		var lblToolTextFormat = _global.labelVars.lblToolTextFormat;
		...
		//case 15: //HREF
		this.href_btn.onPress = function(){t.dragElement(this,"href_ico")};
		this.href_btn.onRelease = function(){t.dropRelease(this)};
		this.href_btn.onReleaseOutside = function(){t.dropElement(this,15)};
		this.href_btn.onRollOver = function(){t.showToolTip(lblToolHref)};
		this.href_btn.onRollOut = function(){t.hideToolTip()};
		//case 16: //TEXTFORMAT
		this.textFormat_btn.onPress = function(){t.dragElement(this,"textFormat_ico")};
		this.textFormat_btn.onRelease = function(){t.dropRelease(this)};
		this.textFormat_btn.onReleaseOutside = function(){t.dropElement(this,16)};
		this.textFormat_btn.onRollOver = function(){t.showToolTip(lblToolTextFormat)};
		this.textFormat_btn.onRollOut = function(){t.hideToolTip()};
	};
