 ...
 *
 *	I should also mention that the only situation in which it is appropriate to use this class
 *	is when you are using Flash MX 2004, AS 2.0, and targeting the Flash Player 6. If you are
 *	targeting the Flash Player 7, use the MovieClipLoader class.
 *
 */
