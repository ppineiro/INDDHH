...
%><?xml version="1.0" ?><forms><data><level width="0" name="id" label="id" type="label" hidden="true" /><level width="40%" name="name" label="Name" type="label" /><level width="60%" name="label" label="Path" type="label" /></data><values><%=values%></values></forms>