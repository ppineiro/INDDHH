...
import mx.controls.TextArea.styleSheet;
import mx.controls.Button;
import com.qlod.LoaderClass;

class com.st.process.view.dialogs.FormConditionModal extends MovieClip{
	...
	function FormConditionModal(Void){
	...
	function onLoad(){
		...
		//var style:TextArea.styleSheet=new TextArea.styleSheet();
