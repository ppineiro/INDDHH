...
class com.st.process.view.elements.Element extends MovieClip{
	...
	var loadedImage:MovieClip=null;
	public function addImage(url){
		imgHolder=this.createEmptyMovieClip("imgHolder",this.getNextHighestDepth());
		loadedImage=imgHolder.createEmptyMovieClip("loadedImage",imgHolder.getNextHighestDepth());
		var mcl:MovieClipLoader=new MovieClipLoader();
		mcl.addListener(this);
		mcl.loadClip(url,loadedImage);
	}
	
	function onLoadComplete(){
		/*var w=imgHolder._width;
		trace(imgHolder._width+" "+imgHolder._height);
		imgHolder._width=17;
		imgHolder._height=(imgHolder._width*imgHolder._height)/w;
		loadedImage._x=(-this._width/2)-10;
		loadedImage._y=(-this._height/2)-10;*/
	}
	...
	function onLoadInit(){
		...
		imgHolder._width=23;
		imgHolder._height=(imgHolder._width*imgHolder._height)/w;
		//loadedImage._x=(-this._width/2);
		//loadedImage._y=(-this._height/2);
		loadedImage._x=-60;
		loadedImage._y=-60;
	}
