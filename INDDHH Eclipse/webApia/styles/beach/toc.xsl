...
<xsl:template match="/">
		...
		<body onload="preloadImages('/images/folder_closed.gif','/images/folder_open.gif','/images/doc.gif')">
			...
			<table class="tocHolder" id="tocHolder" nowrap="true" style="white-space:nowrap;position:static;overflow:hidden;" cellspacing="0" cellpading="0" onMouseOver="mouseOverToc()"><tr><td nowrap="" valign="top">
...
<xsl:template match="ROW[ID_FATHER_NODE=0]">
		...
		<tr>
			<td nowrap="true" width="100%" class="tdInnerTitleAcord">
				...
				<span style="font-weight:normal;"><xsl:value-of select="NAME"/></span>
				</li>
			</td>
		</tr>
		</xsl:if>
