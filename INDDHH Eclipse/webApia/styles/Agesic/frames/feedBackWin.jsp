		...
		<table class="tblTitulo" height="100%">
			<tr>
				<td vAlign="top">
					...
					<div style="border: thin #FFFFFF solid; width: 200px; display:none" id="divTituloWaitStatusImageContainer"><img id="divTituloWaitStatusImage" height="10px" width="0px"></div>
				</td>
			</tr>
		</table>
	</div>
