...
<head><meta http-equiv="X-UA-Compatible" content="IE=7" />
	<script language="javascript" src="<%=Parameters.ROOT_PATH%>/scripts/feedBackFrame.js"<%=defer%>></script>
	<script language="javascript" src="<%=Parameters.ROOT_PATH%>/scripts/modalController.js"<%=defer%>></script>
	<title><%=LabelManager.getName(labelSet,"titSys")%></title>
	...
	<script src="<%=Parameters.ROOT_PATH%>/frames/frames.js" language="Javascript"<%=defer%>></script>
	
	<%@include file="../../../programs/chat/include/framesJs.jsp" %>
	...
	<%@include file="../../../programs/chat/include/framesScripts.jsp" %>

</head>

<body onLoad="init()" scroll="no">
	<iframe name="topFrame" id="topFrame" src="FramesAction.do?action=top&style=<%=styleDirectory %>" scrolling="NO" TABINDEX=-1 FRAMEBORDER=0></iframe>
	<iframe name="workArea" id="workArea" src="FramesAction.do?action=splash" scrolling="NO"  TABINDEX=1 FRAMEBORDER=0></iframe>
	<iframe name="tocArea" id="tocArea" src="FramesAction.do?action=menu" scrolling="NO" TABINDEX=-1 FRAMEBORDER=0></iframe>
	<iframe style="z-index:9999990;" name="iframeResult" id="iframeResult" class="feedBackFrame" frameborder="no" style="display:none;" ></iframe>
	<iframe style="z-index:99999999;" name="iframeMessages" id="iframeMessages" class="feedBackFrame" frameborder="no" style="" src="<%=Parameters.ROOT_PATH%>/styles/<%=styleDirectory %>/frames/feedBackWin.jsp"></iframe>
	<iframe style="z-index:99999999;" name="iframeLogout" id="iframeLogout" class="feedBackFrame" frameborder="no" style="display:none;" src="<%=Parameters.ROOT_PATH%>/frames/logoutFrame.jsp" ></iframe>
</body>
</html>
