...
var checkUniqueSessionIdMessage = "Se ha detectado un acceso desde otra ventana. Su sesión ha sido invalidada. Por Favor acceda ingrese nuevamente al sistema."; //mensaje que se debe mostrar
