...
<form name="frmLogin" id="frmLogin" method="post">
	<table width="100%" height="100%" cellpadding=0 cellspacing=0>
		...
		<tr>
			<td class="degree1" valign="center">
				<img src="<%=Parameters.ROOT_PATH%>/styles/<%= styleDirectory %>/images/logo_Poder_Judicial.gif"></td>
			<td valign="top" >
			<div>
			<table width="100%" height="60px" cellpadding=0 cellspacing=0><tr>
			<!--td class="degree"></td-->
