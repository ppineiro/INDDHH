<%@page import="biz.statum.sdk.util.FileUtil"%><%@page import="biz.statum.sdk.util.StringUtil"%><%@ page import = "java.io.File"%><%@page import="java.io.FileInputStream"%><%@page import="com.st.util.labels.*"%><%@page import="biz.statum.apia.web.action.taskslist.TasksListAction"%><%@page import="biz.statum.apia.web.bean.taskslist.TasksListBean"%><%@page import="biz.statum.sdk.util.HttpServletRequestResponse"%><%
...
try {
	...
	TasksListBean bean = TasksListAction.staticRetrieveBean(http,false);
