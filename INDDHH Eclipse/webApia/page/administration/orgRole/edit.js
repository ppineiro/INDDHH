...
function initPage(){
	...
	initAdminModalHandlerOnChangeHighlight($('prfsContainter'));
	...
	if (optionGenerateChangeDoc) optionGenerateChangeDoc.addEvent('click', function(e) {
		...
		new Request({
			url: 'apia.administration.OrganizationalRoleAction.run?action=downloadChangeDoc&isAjax=true' + atts + TAB_ID_REQUEST,
