...
function processXmlDocInformation(resXml){
	...
	if (information != null && information.length > 0 && information.item(0) != null) {
		...
		var permissions = SHOW_PERMISSIONS ? information.getElementsByTagName("permissions") : null;
		var metadata = SHOW_METADATA ? information.getElementsByTagName("docMetadata") : null;
