...
function updateButtons(){
	if (canDownload && canView){
		...
		$('optionDownload').removeClass("hidden");
		...
		$('optionDownload').removeClass("hidden");
		$('optionDownload').getElement("button").addClass("suggestedAction");
//		$('optionView').setStyle("display","none !important");
		$('optionView').addClass("hidden");
		$('optionView').getElement("button").removeClass("suggestedAction");
	} else if (canView){
//		$('optionDownload').setStyle("display","none !important");
		$('optionDownload').addClass("hidden");
