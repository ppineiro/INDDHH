...
if (QueryExecutionBean.EXPORT_FORMAT_CVS.equals(aBean.getExportFormat())) {
...
} else if (QueryExecutionBean.EXPORT_FORMAT_EXCELX.equals(aBean.getExportFormat())) {
	...
	String tmpFileName = Parameters.TMP_FILE_STORAGE + File.separator + session.getId() + ".xlsx";

	XSSFWorkbook wb = new XSSFWorkbook();
		
	aBean.generateQueryExcelX(http,wb);
