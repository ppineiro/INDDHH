...
<%if(Parameters.CUSTOM_JS.length()>0){
	...
	if(f.exists()){%>
		<script type="text/javascript" src="<%=Parameters.ROOT_PATH + Parameters.CUSTOM_JS%>"></script>
	<%}else{
...
%>
	...
	<!-- MOBILE -->
	<script type="text/javascript" src="<system:util show="context" />/js/mobile/swipe.js"></script>
	<!-- FORMCHECK PARA VALIDAR FORMS-->
	...
	<script type="text/javascript" src="<system:util show="context" />/js/tabs.js"></script>
	...
	<script type="text/javascript" src="<system:util show="context" />/js/numeric.js"></script>
	
	<script type="text/javascript" src="<system:util show="context" />/js/tabs.js"> </script>
	
	<script type="text/javascript" src="<system:util show="context" />/js/datepicker/datepicker.js"> </script>
	
	<script type="text/javascript" src="<system:util show="context" />/js/MutationObserver.js"> </script>

	<link rel="shortcut icon" href="<system:util show="context" />/css/<system:util show="currentStyle" />/favicon.ico">
	
	<script type="text/javascript" src="<system:util show="context" />/js/colorpicker/mooRainbow.js"></script>
	<link rel="stylesheet" href="<system:util show="context" />/js/colorpicker/mooRainbow.css" type="text/css" media="all">
	
	<script type="text/javascript" src="<system:util show="context" />/page/includes/campaigns.js"></script>
	
	<script type="text/javascript" src="<system:util show="context" />/page/externalAccess/postmessage.js"></script>
	
	<script type="text/javascript">
		var MOBILE 					= <%="true".equals(session.getAttribute("mobile")) ? "true" : "false"%>;
		var CURRENT_USER_LOGIN 		= "<system:util show="currentLogin" />";
		var CURRENT_USER_NAME 		= "<system:util show="currentLoginName" />";
