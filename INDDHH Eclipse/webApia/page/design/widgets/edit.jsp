<%@include file="../../includes/startInc.jsp" %><html lang="<%=biz.statum.apia.web.bean.BasicBeanStatic.getUserDataStatic(request).getLangCode()%>"><head><%@include file="../../includes/headInclude.jsp" %><script type="text/javascript" src="<system:util show="context" />/page/design/widgets/edit.js"></script><script type="text/javascript" src="<system:util show="context" />/page/includes/adminActionsEdition.js"></script><script type="text/javascript" src="<system:util show="context" />/page/includes/campaigns.js"></script><script type="text/javascript" src="<system:util show="context" />/page/includes/adminFav.js"></script><script type="text/javascript" src="<system:util show="context" />/page/includes/navButtons.js"></script><script type="text/javascript" src="<system:util show="context" />/page/design/widgets/tabGenData.js"></script><script type="text/javascript" src="<system:util show="context" />/page/design/widgets/tabHistoric.js"></script><script type="text/javascript" src="<system:util show="context" />/page/design/widgets/tabOthData.js"></script><script type="text/javascript" src="<system:util show="context" />/page/design/widgets/tabPerms.js"></script><script type="text/javascript" src="<system:util show="context" />/page/design/widgets/tabActions.js"></script><script type="text/javascript" src="<system:util show="context" />/page/design/widgets/tabSrcData.js"></script><script type="text/javascript" src="<system:util show="context" />/page/design/widgets/tabUpdate.js"></script><script type="text/javascript" src="<system:util show="context" />/page/modals/busClasses.js"></script><script type="text/javascript" src="<system:util show="context" />/page/modals/processes.js"></script><script type="text/javascript" src="<system:util show="context" />/page/modals/attributes.js"></script><script type="text/javascript" src="<system:util show="context" />/page/modals/pools.js"></script><script type="text/javascript" src="<system:util show="context" />/js/modalController.js"></script><script type="text/javascript">
		...
		var LBL_TST_SQL 		= '<system:label show="text" label="btnTestQry" forHtml="true" forScript="true" />';
		var LBL_TST_HTML 		= '<system:label show="text" label="lblTestHtml" forHtml="true" forScript="true" />';
		var LBL_TST_URL 		= '<system:label show="text" label="lblTstUrl" forHtml="true" forScript="true" />';
		var LBL_DEL_SQL 		= '<system:label show="text" label="lblDelSQL" forHtml="true" forScript="true" />';
		var LBL_DEL_HTML 		= '<system:label show="text" label="lblDelHtml" forHtml="true" forScript="true" />';
		var LBL_DEL_URL 		= '<system:label show="text" label="lblDelUrl" forHtml="true" forScript="true" />';
		...
		var LBL_RESULT 			= '<system:label show="text" label="sbtRes" forHtml="true" forScript="true" />';
		var MSG_INS_VAL_POSITIVE = '<system:label show="text" label="msgInsValPositive" forHtml="true" forScript="true" />';
		var LBL_TITLE 			= '<system:label show="text" label="lblTit" forHtml="true" forScript="true" />';
		...
		var widOthCbeVwId = "<system:edit show="value" from="theBean" field="prpOthCbeVwId"/>";
		var widOthQryId = "<system:edit show="value" from="theBean" field="prpOthQryId"/>";
		...
		var btnParsRed = "<system:util show="context" />/css/base/img/btn_mod_red.gif";
		var btnParsBlue = "<system:util show="context" />/css/base/img/btn_mod.gif";
		...
		var WIDGET_KPI_TYPE_RING_ID = "<system:edit show="constant" from="com.dogma.vo.WidgetVo" field="WIDGET_KPI_TYPE_RING_ID" />";
		var WIDGET_KPI_TYPE_RING_NAME = "<system:edit show="constant" from="com.dogma.vo.WidgetVo" field="WIDGET_KPI_TYPE_RING_NAME" />";
		...
		var WIDGET_PRP_BTN_OPEN_OTH_CBE = "<system:edit show="constant" from="com.dogma.vo.WidgetVo" field="WIDGET_PRP_BTN_OPEN_OTH_CBE" />";
		var WIDGET_PRP_BTN_OPEN_OTH_QRY = "<system:edit show="constant" from="com.dogma.vo.WidgetVo" field="WIDGET_PRP_BTN_OPEN_OTH_QRY" />";
		var WIDGET_PRP_OTH_QRY_ID = "<system:edit show="constant" from="com.dogma.vo.WidgetVo" field="WIDGET_PRP_OTH_QRY_ID" />";
		...
		var WIDGET_PRP_NO_VAL_COLOR = "<system:edit show="constant" from="com.dogma.vo.WidgetVo" field="WIDGET_PRP_NO_VAL_COLOR" />";
		var WIDGET_PRP_NO_VAL_COLOR_HEX = "<system:edit show="constant" from="com.dogma.vo.WidgetVo" field="WIDGET_PRP_NO_VAL_COLOR_HEX" />";
		...
		var WIDGET_PRP_VAL_RING_ANCHOR = "<system:edit show="constant" from="com.dogma.vo.WidgetVo" field="WIDGET_PRP_VAL_RING_ANCHOR" />";
		...
		var YELLOW_RGB = 'rgb(255,200,0)';
		var YELLOW_HEX = '#ffc800';
