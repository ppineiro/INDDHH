...
function initPage(){
	...
	if (mode == UPDATE_MODE) {
		$('panelOptions').style.display='none';  //Ocultamos panel de opciones al ingresar
	}
	...
	$('tabUpdate').addEvent("onFocus", function(evt) {
		$('panelOptions').style.display='none';
	});
	
	$('tabHistoric').addEvent("onFocus", function(evt) {
		$('panelOptions').style.display='none';
	});
	
	$('tabPerms').addEvent("onFocus", function(evt) {
		$('panelOptions').style.display='none';
	});
