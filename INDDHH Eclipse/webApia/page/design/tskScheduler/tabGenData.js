...
function loadExclusionDays() {
	var request = new Request({
		method: 'post',
		url: CONTEXT + URL_REQUEST_AJAX + '?action=getExclusionDays&isAjax=true' + TAB_ID_REQUEST,
		onRequest: function() { 
		...
		onComplete: function(resText, resXml) { 
			...
			initAdminModalHandlerOnChangeHighlight($('excDayContainter'));
		}
	});
...
//	if(element) {
//		element.removeEvent('click', actionElementAdminClickRemove);
