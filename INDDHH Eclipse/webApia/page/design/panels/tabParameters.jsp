<script type="text/javascript">
	...
	var PNL_PARAM_VIEW_TYPE_MDL_ATT		= '<system:edit show="constant" from="com.dogma.vo.PnlParameterVo" field="PNL_VIEW_TYPE_MDL_ATTRIBUTE" />';
	var PNL_PARAM_VIEW_TYPE_MDL_POOL	= '<system:edit show="constant" from="com.dogma.vo.PnlParameterVo" field="PNL_VIEW_TYPE_MDL_POOL" />';
	var PNL_PARAM_VIEW_TYPE_MDL_PRF		= '<system:edit show="constant" from="com.dogma.vo.PnlParameterVo" field="PNL_VIEW_TYPE_MDL_PROFILE" />';
	var PNL_PARAM_VIEW_TYPE_MDL_IMG		= '<system:edit show="constant" from="com.dogma.vo.PnlParameterVo" field="PNL_VIEW_TYPE_MDL_IMAGE" />';	
	...
	var LBL_MDL_ATT		= '<system:label show="text" label="lblMdlAtt" forScript="true" />';
	var LBL_MDL_POOL	= '<system:label show="text" label="lblMdlPool" forScript="true" />';
	var LBL_MDL_PRF		= '<system:label show="text" label="lblMdlPrf" forScript="true" />';
	var LBL_MDL_IMG		= '<system:label show="text" label="lblMdlImg" forScript="true" />';
...
</script><div class="aTab"><div class="tab" id="tabParameters"><system:label show="text" label="tabPar" /></div><div class="contentTab" id="contentTabParameters"><div><div class="fieldGroup"><div class="title"><system:label show="text" label="sbtDatPar" /></div><div class="gridContainer" style="margin: 0px;"><div class="gridHeader"><table><thead><tr class="header"><th class="required" title="<system:label show="tooltip" label="lblNom" />"><div style="width: 165px"><system:label show="text" label="lblNom" /></div></th><th class="required" title="<system:label show="tooltip" label="lblTitle" />"><div style="width: 185px"><system:label show="text" label="lblTitle" /></div></th><th title="<system:label show="tooltip" label="lblDesc" />"><div style="width: 185px"><system:label show="text" label="lblDesc" /></div></th><th class="required" title="<system:label show="tooltip" label="lblTip" />"><div style="width: 75px"><system:label show="text" label="lblTip" /></div></th><th class="required" title="<system:label show="tooltip" label="lblOri" />"><div style="width: 100px"><system:label show="text" label="lblOri" /></div></th><th class="required" title="<system:label show="tooltip" label="sbtDisplay" />"><div style="width: 80px"><system:label show="text" label="sbtDisplay" /></div></th></tr></thead></table></div><div class="gridBody" id="gridParams"><table><thead><tr><th width="165"></th><th width="185"></th><th width="185"></th><th width="75"></th><th width="100"></th><th width="80"></th></tr></thead><tbody class="tableData" id="tableParams"><input type="hidden" id="strParams" name="strParams" value=""></tbody></table></div><div class="gridFooter"><div class="listActionButtons" id="gridFooter"><div class="listAddDelRight" ><div class="btnAdd navButton" id="btnAddParam"><system:label show="text" label="btnAgr" /></div><div class="actSeparator">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><div class="btnDelete navButton" id="btnDelParam"><system:label show="text" label="btnEli" /></div></div></div></div></div></div></div></div></div>