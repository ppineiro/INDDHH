...
function initTabParameters(){
	...
	$('tabParameters').addEvent("click", function(evt){
		if (fstTime){
    		fixTableParameters();
    		fstTime = false;
    	}
...
function loadParameters(){
	var request = new Request({
		...
		onComplete : function(resText, resXml) { 
			processXmlParameters(resXml);
			
			var table = $('gridParams'); var footer = $('btnDelParam');
...
function createParameter(paramId,paramName,paramTitle,paramDesc,paramType,paramSrc,paramViewType){
	...
	new Element('option', {'value': PNL_PARAM_VIEW_TYPE_MDL_ATT, html: LBL_MDL_ATT, 'selected': PNL_PARAM_VIEW_TYPE_MDL_ATT == paramViewType }).inject(selectViewType);
	new Element('option', {'value': PNL_PARAM_VIEW_TYPE_MDL_POOL, html: LBL_MDL_POOL, 'selected': PNL_PARAM_VIEW_TYPE_MDL_POOL == paramViewType }).inject(selectViewType);
	new Element('option', {'value': PNL_PARAM_VIEW_TYPE_MDL_PRF, html: LBL_MDL_PRF, 'selected': PNL_PARAM_VIEW_TYPE_MDL_PRF == paramViewType }).inject(selectViewType);
	new Element('option', {'value': PNL_PARAM_VIEW_TYPE_MDL_IMG, html: LBL_MDL_IMG, 'selected': PNL_PARAM_VIEW_TYPE_MDL_IMG == paramViewType }).inject(selectViewType);
