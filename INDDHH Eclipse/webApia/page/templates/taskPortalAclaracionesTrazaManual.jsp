...
/* 	} */
	...
	br + label.optionLabel {
		margin-left: 232px;
	}
	
	div.fieldGroup div.field label.optionLabel > * {
		vertical-align: top;
		margin-top: 0px;
	}
...
/* 	   	} */
	...
	/*CSS ESPECFICO TRAMITES EN LINEA*/
	#btnCloseTab {
		display: none;
	}
	...
	/*Este estilo se pone a fuego para eliminar metadatos, permisos y tipo de documentos respectivamente en el fomrulario de documentos de la entidad */	
		
	#metadata, #permission, #frmModalDocumentUpload div.mdlBody > table > tbody > tr:first-child{
		 display: none;
	}
...
// 			var formTitulo = ApiaFunctions.getForm("SELECCIONAR_EXPEDIENTE");
// 			var formResultado = ApiaFunctions.getForm("DATOS_EXPEDIENTE_WS");
// 			if (formTitulo == null && formResultado == null){
...
// 			}	
			...
			document.getElementById("titleTramite").innerHTML = "Solicitud de aclaraciones <br><br>";						
		...
		<form id="frmData" action="dummy" method="post">
			...
			<div class="dataContainer">
				<div class='tabComponent' id="tabComponent">
					<label id="titleTramite" class="titleTramite"><%=request.getParameter("eatt_STR_TRM_NOMBRE_STR")%></label>
