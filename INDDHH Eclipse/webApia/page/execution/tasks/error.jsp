<%@page import="com.st.util.labels.LabelManager"%><%request.setAttribute("isTask","true"); %><%@include file="../../includes/startInc.jsp" %><html lang="<%=biz.statum.apia.web.bean.BasicBeanStatic.getUserDataStatic(request).getLangCode()%>"><head><%@include file="../../includes/headInclude.jsp" %><script type="text/javascript">
	function initPage(){
		checkErrors();	
	...
	</script></head><body><div class="body" id="bodyDiv"><form id="frmData" action="" method="post"><div class="optionsContainer"><div class="fncPanel info"><system:campaign inLogin="false" inSplash="false" location="verticalUp" /><div class="title"><%String errType = request.getParameter("errType");
