...
<%@page import="java.util.LinkedHashMap"%><%@page import="java.util.Collection"%><%@page import="java.util.HashMap"%><%@page import="biz.statum.apia.web.bean.BeanUtils"%><%@page import="com.dogma.vo.BusEntInstCommentVo"%><%@page import="biz.statum.sdk.util.HttpServletRequestResponse"%><%@page import="biz.statum.apia.web.tag.TagUtils"%><%@page import="com.st.util.labels.LabelManager"%><div class="tabContent"><%
	...
	if (! IS_READONLY ) { %><div class="fieldGroup"><div class="title"><system:label show="text" label="sbtEjeEntComAct" /></div><div class="fieldFull"><div class="field fieldComment"><label for="txtComment" title="<system:label show="tooltip" label="lblEjeEntCom" />"><system:label show="text" label="lblEjeEntCom" />:</label><textarea id="txtComment" name="txtComment" ><%=current_comment%></textarea></div></div><div class="fieldFull"><div class="field fieldCommentOption"><input type="checkbox" id="chkAddAlert" name="chkAddAlert"><label for="chkAddAlert" title="<system:label show="tooltip" label="lblEjeAgrMar" />"><system:label show="text" label="lblEjeAgrMar" /></label></div><div class="field fieldCommentOption"><input type="checkbox" id="chkAddAllAlert" name="chkAddAllAlert"><label for="chkAddAllAlert" title="<system:label show="tooltip" label="lblEjeAgrMarTod" />"><system:label show="text" label="lblEjeAgrMarTod" /></label></div><div class="field fieldCommentOption"><input type="checkbox" id="chkRemAlert" name="chkRemAlert"><label for="chkRemAlert" title="<system:label show="tooltip" label="lblEjeEliMar" />"><system:label show="text" label="lblEjeEliMar" /></label></div></div></div><%} %><% if (comments != null) { %><div class="fieldGroup"><div class="title"><system:label show="text" label="sbtEjeEntCom" /></div><table id="tblComment" class="tblComment" title="<system:label show="text" label="sbtEjeEntCom" />"><tbody><%=comment_table%></tbody></table></div><% } %></div>	