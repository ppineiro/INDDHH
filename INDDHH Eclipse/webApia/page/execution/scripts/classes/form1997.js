...
//		}
	...
	collapseForm: function(noFx) {
		...
		this.max_height = Generic.getHiddenHeight(this.DOMform) ;
		if(this.max_height < current_form.DOMform.getChildren('table')[0].getHeight()){
			current_form.max_height = current_form.DOMform.getChildren('table')[0].getHeight();
		}
		//Collapse form			
		var fx = new Fx.Morph(current_form.DOMform.getChildren('table')[0], {
			duration: noFx ? 10 : 100,
