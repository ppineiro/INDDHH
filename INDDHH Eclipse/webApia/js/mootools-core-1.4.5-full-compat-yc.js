...
}}}N=this.found;}}if(I||(F.expressions.length>1)){this.sort(p);}return(s)?(p[0]||null):p;};k.uidx=1;k.uidk="data-slick-uniqueid";k.getUIDXML=function(n){var c=n.getAttribute(this.uidk);
