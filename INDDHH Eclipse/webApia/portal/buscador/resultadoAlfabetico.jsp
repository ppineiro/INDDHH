...
ArrayList<Tramite> arr = tdao.getTramitesAlfabeticoTodos(texto, 1);
...
<div class="contenedor buscadorResultados cfx">
	...
	<div class="contenido cfx">
		...
		<%}else{ %>
			...
			%>
			<div class="left">
				<h3>Resultados de búsqueda para: <strong><%=texto%></strong></h3>
			</div>
			...
			<div class="paginado">
				<ul class="cfx">
					<%if (PAGINA_ACTUAL > 1){
						...
						url = url + "/portal/buscador/resultadoAlfabetico.jsp";
							url = url + "?q=" + texto;		
