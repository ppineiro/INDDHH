...
<html>
	...
	<body onLoad="loadDescargaEnEspera()">
		...
		<div class="body" id="bodyDiv">
			<form id="frmData" action="" method="post">
				...
				<div id="menuContainer" class="optionsContainer menuContainer containerES">
					
					<div id="taskInfoContainer" class="campaign taskInfoContainer infoContainerES">
						...
						<div id="taskContent" class="taskContent taskContentES">
							<div id="imgTask" class="imgTask imgTaskES"></div>
							<div id="descTask" class="descTask descTaskES">Tarea en la cual es posible quitar de espera un expediente que se encuentra en espera.</div>
						</div>
										
					</div>	
					
					<div id="expedienteContainer" class="expedienteContainer expedienteContainerES">
						<div class="title">
							<span id='ExpTitle'> </span>
						</div>
											
						<div id="dowloadContainer" class="dowloadContainer dowloadContainerES">
