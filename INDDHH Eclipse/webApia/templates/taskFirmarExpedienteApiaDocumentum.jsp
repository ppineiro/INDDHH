...
<html>
	<head>
		...
		<style type="text/css">
			...
			/* Div General */
			#menuContainer { position: absolute; width: 320px; height: 600px; display: inline-block; float: right; right: 0px; z-index: 1; background-color: #FFF; }
			
			/* Panel de la tarea */	
			#taskInfoContainer { position: absolute; width: 320px; height: 125px; }
			#taskTitleContainer { position: absolute; top: 0%; }
			#taskContent { position: absolute; top:20%; width: 300px; height: 100px; }
			#imgTask { position: absolute; top: 10%; background: url(/Apia/templates/img/firmar_expediente.png); background-size: 80px; background-repeat: no-repeat; width: 80px; height: 75px; } 
			#descTask{ position: absolute; top: 35%; left: 40%; width: 130px; font-size: 12px; }
			...
			/* Menu de botones */
			#buttonsActions{ position: absolute ; top: 22%; }
			...
			<form id="frmData" action="" method="post">
				...
				<div id="menuContainer" class="optionsContainer">
						...
						<div id="taskInfoContainer" class="campaign"><system:campaign inLogin="false" inSplash="false" location="verticalUp" />				
							...
							<div id="taskContent">
									<div id="imgTask"></div>
									<div id="descTask">Firmar expediente.</div>
							</div>
