...
<head>
	...
	<style type="text/css">
		...
		#imgTask { position: absolute; top: 10%; left: 7%; background: transparent url("templates/img/pase_masivo.png") no-repeat scroll 0% 0% / 45px auto; width: 50px; height: 50px; background-size: 50px; } 
		...
		/* Otros */
		#area_E_3450_1_ifr { height: 225px !important; } 	/* TAMAÑO IFRAME DE ACTUACION DE PASE MASIVO */
		...
		<form id="frmData" action="" method="post">
			...
			<div id="menuContainer" class="optionsContainer">
				...
				<div id="taskInfoContainer" class="campaign"><system:campaign inLogin="false" inSplash="false" location="verticalUp" />				
						...
						<div id="taskContent">
							<div id="imgTask"></div>
							<div id="descTask">Tarea en la cual es posible hacer un pase de varios expedientes en forma simultánea.</div>
						</div>
