...
<head>
	...
	<style type="text/css">
		...
		#descTask{ position: absolute; top: 15%; left: 28%; width: 190px; font-size: 12px; text-align: justify; }
			...
			<div class="optionsContainer">
				<div class="fncPanel info">
					...
					<div class="content divFncDescription">
						...
						<div class="descTask" id="descTask">Tarea en la cual un usuario puede declararse como ausente.</div>
						<div class="clear"></div>
					</div>
				</div>			
