	...
	<head>
		...
		<script type="text/javascript">
			...
			function view(){
				...
				if (count == 0){
					document.getElementsByName("rb_descarga")[2].checked = true;
					...
					document.getElementsByName("rb_descarga")[0].checked = true;
					if (count <= 3){
						document.getElementById("trSecond").style.display = "none";
						...
						if (count == 1){
							document.getElementById("lbFirst").innerHTML = "Descargar última actuación";
							...
							document.getElementById("size1").style.left = "53%";
						} else{
							document.getElementById("lbFirst").innerHTML = "Descargar últimas " + count + " actuaciones";
							var tamanio = 0;
							...
							document.getElementById("size1").style.position = "relative"; 
							document.getElementById("size1").style.left = "39.5%"; 	
						}
						...
						document.getElementById("lbFirst").innerHTML = "Descargar últimas 3 actuaciones";
						var tamanio = 0;
						for(var i=0 ; i < 3 ; i++){
						...
						tamanio = 0;
						if (count == 4){
							document.getElementById("lbSecond").innerHTML = "Descargar últimas 4 actuaciones";
							for(var j=0 ; j < 4 ; j++){
							...
							document.getElementById("lbSecond").innerHTML = "Descargar últimas 5 actuaciones";
							for(var j=0 ; j < 5 ; j++){
								tamanio += parseInt(sizes.split(sep)[j]);
							}
							document.getElementById("lbSecondSize").innerHTML = "Tama\u00f1o: " + getSizeUnidad(tamanio);
							...
							document.getElementById("size2").style.left = "38.75%";
						}						
					}
		...
		<style type="text/css">
			...
			td.size2{ position: relative; left: 39.5%; }
	...
	<body onLoad="view()">
		...
		<table width="100%">
			<tbody>
				...
				<tr id="trFirst">
				<td><input class="radio" type="radio" name="rb_descarga" value="U3"></td>
				...
				<tr id="trSecond">
				<td><input class="radio" type="radio" name="rb_descarga" value="U5"><br></td>
				<td><div id='imgPdfDoc'></div></td>
				...
				<tr id="trThird">
				<td><input class="radio" type="radio" name="rb_descarga" value="descargar"><br></td>
				<td><div id='imgPdfDoc'></div></td>
				<td><label>Descargar expediente <%=exp%></label></td>
