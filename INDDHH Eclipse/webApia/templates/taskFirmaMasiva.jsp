...
<head>
	...
	<style type="text/css">
		...
		#imgTask { position: absolute; top: 15%; left: 5%; background: transparent url("templates/img/firma_masiva.png") no-repeat scroll 0% 0% / 45px auto; width: 56px; height: 53px; background-size: 56px; } 
		...
		<form id="frmData" action="" method="post">
			...
			<div id="menuContainer" class="optionsContainer">
				...
				<div id="taskInfoContainer" class="campaign"><system:campaign inLogin="false" inSplash="false" location="verticalUp" />				
						...
						<div id="taskContent">
							<div id="imgTask"></div>
							<div id="descTask">Tarea en la cual es posible firmar varias carátulas, actuaciones o pases a la firma, en forma simultánea.</div>
						</div>
