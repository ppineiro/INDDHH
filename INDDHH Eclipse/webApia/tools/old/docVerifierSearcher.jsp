...
%><%@page import="com.dogma.Parameters"%><% 	boolean tryOpen = "true".equals(request.getParameter("tryOpen"));  %><html><head><title>Document Verifier and Searcher</title><style type="text/css">
		body {
			font-family: verdana;
			font-size: 10px;
		}
	...
	</style></head><body><% String sql = "select * from document where doc_path like 'entInstaces/1001-%'"; %>
...
Start again? <a href="?">[YES]</a><br><% if (request.getParameter("execute") == null) { %><b><font color="red">[ WARNING ]</font></b> The execution of this code may require time and memory. Are you sure you want to continue? <a href="?execute=true">[YES]</a><br><b><font color="red">[ WARNING ]</font></b> The execution of this code may require time and memory. Are you sure you want to continue? <a href="?execute=true&saveTo=file">[YES - Generate result in file]</a><% } else { %><hr><%
	...
	if (files != null && files.size() > 0) {
		...
		No files where found to analyze in the file system.<br><% } %><br>
