<%@ page contentType="text/html; charset=iso-8859-1" language="java"%><%@page import="com.dogma.ws.*"%><html><head><title>TestWs</title></head><body><form>
...
Name <input type="text" name="toTestName"><br><input type="submit" value="test"></form><% 
...
if (wsAddress != null && ! "".equals(wsAddress)) { %>
	...
	} catch (Exception e) { %><b>Ouch!!! Error:</b><br><%
