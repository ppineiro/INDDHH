...
Try open: <%= tryOpen %> (?tryOpen=true to try to open the file)<br><br>

<table border="1" cellpadding="0" cellspacing="0">
	<tr>
   		<td align="center"><b>File</b></td>
   		<td align="center"><b>isFile</b></td>
   		<td align="center"><b>exists</b></td>
   		<td align="center"><b>canRead</b></td>
   		<% if (tryOpen) { %><td>open</td><% } %>
   		<td align="center"><b>path</b></td>
   		<td align="center"><b>user</b></td>
   		<td align="center"><b>date</b></td>
   		<td align="center"><b>other files</b></td>
	</tr>
		...
		ps = StatementFactory.getStatement(con,"select * from document",StatementFactory.DEBUG);
     	...
     	while (resultSet.next()) {
     		...
     		<tr>
	     		...
	     		<td><%= aFile.getAbsolutePath() %></td>
	     		<td><%= resultSet.getString("REG_USER") %></td>
