...
%><%@page import="com.dogma.Parameters"%><%@page import="com.st.util.FileUtil"%><%@page import="com.dogma.Configuration"%><html><head></head><body>
...
if (chars != null && chars.length() == 0) chars = null; %><b>Tests</b><hr><b>Create folder</b>:<br><%= this.createFolder(chars) %><br><b>Create file</b>:<br><%= this.createFile(chars) %><br><b>Append content</b>:<br><%= this.appendContent(chars) %><br><b>Read content</b>:<br><%= this.readContent() %><br><b>Copy file</b>:<br><%= this.copyfile(chars) %><br><b>Delete file</b>:<br><%= this.deleteFile() %><br><b>Delete folder</b>:<br><%= this.deleteFolder() %><br></body></html>
