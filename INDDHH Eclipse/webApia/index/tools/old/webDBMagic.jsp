...
%><html><form action="webDBMagic.jsp">
Acceso a datos "El flaco"®... <br>
Type an SQL Statement:
<%if (request.getParameter("sql")!=null) {%><input type=text name=sql size="100" value="<%=request.getParameter("sql")%>"><%}else{%><input type=text name=sql size="100" value=""><%}%><input type=submit value="Execute"></form><%
if (request.getParameter("sql")!=null) {
    ...
    try {
			...
			if (request.getParameter("sql").indexOf("delete") == -1) {
