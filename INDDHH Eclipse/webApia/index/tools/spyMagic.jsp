...
<html>
<body>
<font size=8>Explorer <font color=blue>"El flaco"®</font></font>   <font size=4>siempre un paso adelante</font>
...
<Table>
	<TR>
		<TD colspan=3><b>Directory of <%=dir%>:</b></TD>
	</TR>
	<TR>
		<TD bgcolor="#F0F5F7"><B>Name</B></TD>
		<TD bgcolor="#F0F5F7"><B>Size</B></TD>
		<TD bgcolor="#F0F5F7"><B>Date</B></TD>
	</TR>
<%
int cantFiles = 0;
long cantBytes = 0;
