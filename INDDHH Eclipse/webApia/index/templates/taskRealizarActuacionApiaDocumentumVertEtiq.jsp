...
<html>
	<head>
		...
		<style type="text/css">
			...
			#menuTabTable { position: absolute; top: 20%; width: 285px; height: 160px; left: 5%; border: 0px solid red; }
			...
			div.actuar { position: absolute; width: 110px; height: 30px; top: 1%; left: 1%; border: 0px solid blue; cursor: pointer; }
			div.actuar:hover{ color: #0679B8; }
			#imgActuar { position: absolute; left: 6%; top: 5%; width: 24px; }
			span.actuar { position: absolute; top: 25%; left: 32%; }
			
			div.modf_cara { position: absolute; width: 110px; height: 30px; top: 26%; left: 1%; border: 0px solid blue; cursor: pointer; }
			div.modf_cara:hover{ color: #0679B8; }
			#imgModCar { position: absolute; left: 2%; top: 10%; width: 24px; }			
			span.modf_cara1 { position: absolute; top: 10%; left: 30%; }
			span.modf_cara2 { position: absolute; top: 50%; left: 32%; }
			
			div.elem_fisc { position: absolute; width: 110px; height: 30px; top: 52%; left: 1%; border: 0px solid blue; cursor: pointer;}
    		div.elem_fisc:hover{ color: #0679B8; }
			#imgElemFisc { position: absolute; left: 3%; top: 10%; width: 24px; }
			span.elem_fisc1 { position: absolute; top: 9%; left: 30%; }
			span.elem_fisc2 { position: absolute; top: 52%; left: 40%; }
			
			div.acc_rest { position: absolute; width: 110px; height: 30px; top: 78%; left: 1%; border: 0px solid blue; cursor: pointer; }
    		div.acc_rest:hover{ color: #0679B8; }
			#imgAccRest { position: absolute; left: 2%; top: -1%; width: 28px; }
			span.acc_rest1 { position: absolute; top: 7%; left: 31%; }
			span.acc_rest2 { position: absolute; top: 49%; left: 31%; }
			
			div.hist { position: absolute; width: 110px; height: 30px; top: 1%; left: 53%; border: 0px solid blue; cursor: pointer; }
			div.hist:hover{ color: #0679B8; }
			#imgHist { position: absolute; left: 2%; top: 10%; width: 24px; }
			span.hist1 { position: absolute; top: 5%; left: 30%; width: 64px; }
			span.hist2 { position: absolute; top: 45%; left: 30%; }
			
			div.acords { position: absolute; width: 110px; height: 30px; top: 26%; left: 53%; border: 0px solid blue; cursor: pointer; }
			div.acords:hover{ color: #0679B8; }
			#imgAcord { position: absolute; left: 2%; top: 5%; width: 24px; }
			span.acords1 { position: absolute; top: 10%; left: 30%; width: 64px; }
			span.acords2 { position: absolute; top: 52%; left: 30%; }
			
			div.relads { position: absolute; width: 110px; height: 30px; top: 52%; left: 53%; border: 0px solid blue; cursor: pointer; }
			div.relads:hover{ color: #0679B8; }
			#imgRelac { position: absolute; left: 2%; top: 10%; width: 24px; }
			span.relads1 { position: absolute; top: 7%; left: 30%; width: 64px; }
			span.relads2 { position: absolute; top: 50%; left: 42%; }
			
			div.incorporados { position: absolute; width: 110px; height: 30px; top: 78%; left: 53%; border: 0px solid blue; cursor: pointer; }
			div.incorporados:hover{ color: #0679B8; }
			#imgIncPar { position: absolute; left: 3%; top: 5%; width: 24px; }
			span.incorporados1 { position: absolute; top: 9%; left: 29%; width: 64px; }
			span.incorporados2 { position: absolute; top: 50%; left: 40%; }			
			
			/* Menu de botones */
			#buttonsActions{ position: absolute ; top: 60%; }
