...
function doXMLLoad(){
	var sXMLSourceUrl = "attsXML.jsp?name=" + escape(document.getElementById("txtNom").value) + "&type=<%= request.getParameter("type") %>&showNative=<%= request.getParameter("showNative") %>";
