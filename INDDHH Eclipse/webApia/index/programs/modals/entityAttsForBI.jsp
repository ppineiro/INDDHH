...
function doXMLLoad(page){
	var sXMLSourceUrl = "entityAttsForBIXML.jsp?busEntId=" + <%= request.getParameter("busEntId") %> + "&envId=" +  <%= request.getParameter("envId") %> + "&page="+page;
