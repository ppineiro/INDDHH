...
function doXMLLoad(){
	var sXMLSourceUrl = "entityAttsXML.jsp?name=" + escape(document.getElementById("txtNom").value) + "&type=" + "<%= request.getParameter("type") %>" + "&str=" + "<%= request.getParameter("str") %>";
