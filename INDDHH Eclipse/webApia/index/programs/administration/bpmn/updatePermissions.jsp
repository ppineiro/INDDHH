<div type="tab" style="visibility:hidden" style="visibility:hidden;" tabTitle="<%=LabelManager.getToolTip(labelSet,"tabPer")%>" tabText="<%=LabelManager.getName(labelSet,"tabPer")%>"><%
Collection colPerms = dBean.getColPermissions();
boolean withProject = (proVo.getPrjId()!=null);
