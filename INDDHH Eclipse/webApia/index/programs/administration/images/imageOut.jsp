<%@page import="java.io.*" %><%@page import="javax.imageio.*"%><%@page import="java.awt.*"%><%@page import="java.awt.image.BufferedImage"%><jsp:useBean id="imagePickerBean" scope="session" class="com.dogma.bean.administration.ImagesBean"></jsp:useBean><%
Image image;
