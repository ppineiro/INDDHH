...
function down_click() {
	lastSelection=oColumnas.selectedItems[0];
	if ((lastSelection != null) && ((lastSelection.rowIndex) < document.getElementById("oColumnas").rows.length)) {
...
function btnConf_click() {
	if (verifyRequiredObjects()) {
		document.getElementById("frmMain").action = "query.TaskListAction.do?action=setColumn&workMode=" + WORK_MODE;
