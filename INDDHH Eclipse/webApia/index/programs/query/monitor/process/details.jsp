...
function btnBack_click() {
  if (<%= dBean.isQueryGoBack() %>) {
  	document.getElementById("frmMain2").action = "query.QueryAction.do?action=returnAction";
  } else if (<%= dBean.isFromTask() %>) {
  	document.getElementById("frmMain2").action = "query.MonitorProcessesAction.do?action=backToTask";
  } else if (<%= dBean.isFromQueryProcessMonitor() %>) {
  	document.getElementById("frmMain2").action = "query.ProcessMonitorAction.do?action=backList";
  } else {
  	document.getElementById("frmMain2").action = "query.MonitorProcessesAction.do?action=search";
  }
