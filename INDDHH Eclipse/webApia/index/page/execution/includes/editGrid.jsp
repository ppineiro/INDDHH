...
// 					showMessage("Error in business class " + currentClassP + "', contact system administrator");
	...
	%></head><body><div class="header"></div><div class="body" id="bodyDiv"><form id="frmData" action="" method="post"><div id="<%=divId%>" class="formContainer" xml="<%out.print(xml);%>"></div></form></div><div class="footer"></div><%@include file="../../modals/documents.jsp" %><%@include file="endInclude.jsp" %></body></html>