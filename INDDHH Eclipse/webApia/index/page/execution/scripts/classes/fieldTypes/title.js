...
var Title = new Class({
	...
	apijs_setProperty: function(prp_name, prp_value) {
		...
		if(prp_name == Field.PROPERTY_NAME) {
			...
			this.content.getElement('span').tooltip(prp_value, { mode: 'auto', width: 200, hook: 0, mouse:true, click:false});
	...
	parseXML: function() {
		...
		*/
		...
		if(this.options[Field.PROPERTY_TOOLTIP]) {
			span.tooltip(this.options[Field.PROPERTY_TOOLTIP], { mode: 'auto', width: 200, hook: 0, mouse:true, click:false});
		}
	},
