...
</script><div id="divAdminActEdit" class="fncPanel buttons"><div id="apiaSocialShare" class="apiaSocialShare"></div><div class="title" style=""><system:label show='text' label='lblChnSoc'/><div id="btnApiaSocialRefresh" class="btnApiaSocialRefresh"></div></div><div class="content" style="height: 200px;"><div id="apiaSocialExecPanel" class="apiaSocialExecPanel"><div id="apiaSocialNoMessages" class="apiaSocialNoMessages"><system:label show='text' label='msgNoMessages' forHtml='true'/></div></div></div></div>	
