function initOthDataTab(mode) {
	...
	//Seteamos la acción de boton agregar info de la grilla
	...
	//Seteamos la acción de boton eliminar info de la grilla
...
function loadInfoGrid(){
	var request = new Request({
		...
		onComplete: function(resText, resXml) {loadInfoXML(resXml);  }
	}).send();
}
