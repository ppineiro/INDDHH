...
try{
	...
	if (request.getParameter("indType")!=null){
		...
		//Create chart
		if (WidgetVo.WIDGET_KPI_TYPE_GAUGE_VELOCIMETER_ID == Integer.parseInt(indType)) { //Si es de GAUGE VELOCIMETRO
