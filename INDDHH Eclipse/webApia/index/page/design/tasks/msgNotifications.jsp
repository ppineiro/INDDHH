...
</script><system:edit show="ifModalNotLoaded" field="msgNotifications.jsp"><system:edit show="markModalAsLoaded" field="msgNotifications.jsp" /><div id="mdlMsgNotificationsContainer" class="mdlContainer hiddenModal"><div class="mdlHeader"><span id="mdlTitle"></span></div><div class="mdlBody" id="mdlBody"><div class="fieldGroup"><div class="fieldModal"><label title="<system:label show="tooltip" label="lblSubMen" />"><system:label show="text" label="lblSubMen" />:</label><textarea rows="2" cols="90" id="msgSubject"></textarea></div><div class="fieldModal"><label title="<system:label show="tooltip" label="lblTexMen" />"><system:label show="text" label="lblTexMen" />:</label><textarea rows="4" cols="90" id="msgText"></textarea></div></div><div class="fieldGroup"><div class="field extendedSize" style="margin-left: 5px;"><span><system:label show="text" label="lblTskMenTok1" /></span><span><system:label show="text" label="lblTskMenTok3" /></span><span><system:label show="text" label="lblTskMenTok2" /></span></div></div></div><div class="mdlFooter"><div class="modalButton" id="btnConfirmMsgNotificationsModal" title="<system:label show="text" label="btnCon" />"><system:label show="text" label="btnCon" /></div><div class="modalButtonSecundary" id="btnDefaultMsgNotificationsModal" title="<system:label show="text" label="btnDefMes" />"><system:label show="text" label="btnDefMes" /></div><div class="close" id="closeModalMsgNotifications" title="<system:label show="text" label="btnCer" />"><system:label show="text" label="btnCer" /></div></div></div></system:edit>