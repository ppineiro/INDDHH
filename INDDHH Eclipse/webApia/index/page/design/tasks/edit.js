...
function addActionElementLanguage(container, text, id, helper) {
	...
	//si no est�, se agrega
	var divElement = new Element('div.option.optionRemove', {
		id: id,
		helper: helper,
		html: text
	});
	//divElement.set("id", id).set("helper",helper);
...
function loadLanguage(){
	var request = new Request({
		method: 'post',
		url: CONTEXT + URL_REQUEST_AJAX +'?action=getLanguages' + TAB_ID_REQUEST,
