...
function updateConnections() {
	var request = new Request({
		method: 'post',
		url: CONTEXT + URL_REQUEST_AJAX + '?action=updateCons' + TAB_ID_REQUEST,
		onRequest: function() {},
...
function updateFileName() {
	var request = new Request({
		method: 'post',
		url: CONTEXT + URL_REQUEST_AJAX + '?action=getFileName' + TAB_ID_REQUEST,
		onRequest: function() {},
...
function testSqlView(onConfirm){
	...
	if (!onConfirm && sql.indexOf("${")>0){
		...
		var request = new Request({
			method: 'post',
			url: CONTEXT + URL_REQUEST_AJAX + '?action=sqlTest' + TAB_ID_REQUEST + '&onConfirm=' + onConfirm,
			onRequest: function() {},
			onComplete: function(resText, resXml) {modalProcessXml(resXml); }
		});
