<div style="position: relative;"><div id="qryFixedColumn"
		style='background-image: none; height: inherit;'><table cellpadding="0" cellspacing="0"><thead><tr class="header"><th width="155px" style='width: 10%;'><div
							style="width: 155px;">Campo</div></th></tr></thead><tbody class="tableData"><tr><td width="155px" style='width: 155px;'><div class="width150"><span><system:label show="text" label="lblQryColName" /></span></div></td></tr><system:edit show="ifValue" from="theEdition" field="freeSQL"
					...
					value="O"><tr><td width="155px" style='width: 155px;'><div
								class="width150"><span><system:label show="text"
										label="lblQryShowAsMoreInfo" /></span></div></td></tr></system:edit><tr><td width="155px" style='width: 155px;'><div class="width150"><span><system:label show="text" label="lblShowAsInt" /></span></div></td></tr><tr><td width="155px" style='width: 155px;'><div class="width150"><span><system:label show="text" label="lblIsDocument" /></span></div></td></tr></tbody></table></div><div style="margin-left: 168px;"><div class="gridBody gridHeader"
			style='background-image: none; height: inherit;'><!-- Cuerpo de la tabla --><table cellpadding="0" cellspacing="0" id="bodyShow"><thead><tr class="header"><th class="hideTD"></th></tr></thead><tbody class="tableData" id="tblShows"><tr><td class="hideTD"></td></tr><system:edit show="ifValue" from="theEdition" field="freeSQL"
	...
	style="<system:edit show="value" from="theBean" field="tblModValue">style='display:none'</system:edit>"><div class="field fieldTwoFifths"><label
			...
			for="chkForceDelRelation" class="label"><system:label
				show="text" label="lblQryColModValue" />:&nbsp;</label><system:edit show="value" from="theBean" field="selQryColIdModValue" /></div><div class="field"
		<system:edit show="ifNotFlag" from="theEdition" field="3" >style='display:none'</system:edit>><system:edit show="ifFlag" from="theEdition" field="3"><system:edit show="value" from="theBean"
				field="selQryColIdModValueParam" /></system:edit><system:edit show="ifNotFlag" from="theEdition" field="3"><input type="hidden" value="-1" name="selQryColIdModValueParam"></system:edit></div><div class="field fieldTwoFifths"><label
			title="<system:label show="tooltip" label="lblQryColModText" />"
			class="label"><system:label show="text"
				label="lblQryColModText" />:&nbsp;</label><system:edit show="value" from="theBean" field="selQryColIdModText" /><system:edit show="ifFlag" from="theEdition" field="3"><system:edit show="value" from="theBean"
				field="selQryColIdModTextParam" /></system:edit><system:edit show="ifNotFlag" from="theEdition" field="3"><input type="hidden" value="-1" name="selQryColIdModTextParam"></system:edit></div></div>
