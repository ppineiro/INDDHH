function initPage(){
	...
	if (btnCon){
		...
		e.stop();
		if(selectionCount($('tableData')) == 0 || selectionCount($('rightTableData'))==0) {
...
function confirm(){
	...
	var selected = getSelectedRows($('rightTableData'));
	var selection = "";
