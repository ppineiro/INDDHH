...
<script type="text/javascript">
	...
	var lblPro					= '<system:label show="text" label="lblPro"/>';
...
</script><system:edit show="ifModalNotLoaded" field="datesModal.jsp"><system:edit show="markModalAsLoaded" field="datesModal.jsp" /><div id="dateModalContainer" class="mdlContainer hiddenModal"><div class="mdlHeader"><system:label show="tooltip" label="lblModDate" /></div><div class="mdlBody" id="mdlBody" style="max-height: 500px; overflow: auto;"></div><div class="mdlFooter"><div class="modalButton" id="btnConDatesModal" title="<system:label show="tooltip" label="btnCon" />"><system:label show="text" label="btnCon" /></div><div class="close" id="closeDatesModal"><system:label show="text" label="btnCer" /></div></div></div></system:edit>