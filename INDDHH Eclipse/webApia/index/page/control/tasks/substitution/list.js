...
function initPage(){
	...
	$('startDateFilter').setFilter = setFilter;
	$('startDateFilter').addEvent("change", function(e) {
		this.setFilter();
	});
	$('endDateFilter').setFilter = setFilter;
	$('endDateFilter').addEvent("change", function(e) {
		this.setFilter();
	});
