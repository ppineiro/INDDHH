...
function initDocTypeMdlPage(){
	...
	['orderByNameDocTypeMdl','orderByTitleDocTypeMdl'].each(function(ele){
		$(ele).addEvent("click", function(e) {
			e.stop();
			callNavigateOrder(this.getAttribute('sortBy'),this,'/apia.modals.DocumentTypeAction.run','DocType');
		});
	});
	
	window.sp_DocType = new Spinner($('tableDataDocType'), {message: WAIT_A_SECOND});
