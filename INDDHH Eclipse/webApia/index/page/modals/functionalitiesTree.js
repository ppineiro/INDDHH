...
function showTreeFncsModal(selecteds, envId, retFunction, closeFunction){
	...
	setTree(selecteds,envId)
	mdlTreeFncsContainer.position();
}

function setTree(selecteds, envId){
	...
	var request = new Request({
		method : 'post',
		async: false,
		url : CONTEXT + URL_REQUEST_AJAX_TREE_FNC + '?action=loadFuncsTreeMode&tree=true&isAjax=true&txtEnvId=' + envId + TAB_ID_REQUEST,
		onRequest : function() { },
