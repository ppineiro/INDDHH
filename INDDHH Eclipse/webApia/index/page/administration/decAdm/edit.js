...
function loadPools(){
	var request = new Request({
		method: 'post',
		url: CONTEXT + '/apia.administration.UsersAction.run?action=getUserPools&disableHie=true' + TAB_ID_REQUEST,
		onRequest: function() { sp.show(true); },
...
function loadProfiles(){
	var request = new Request({
		method: 'post',
		url: CONTEXT + '/apia.administration.UsersAction.run?action=getUserProfiles&disableHie=true' + TAB_ID_REQUEST,
		onRequest: function() { sp.show(true); },
