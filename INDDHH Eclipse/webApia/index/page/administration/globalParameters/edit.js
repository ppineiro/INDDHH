...
function initPage(){
	...
	['formatTab','locTab','logTab','emailTab','otherTab','chatTab','authenticationTab','biTab'].each(function(ele) {
		...
		ele.buttons = buttons;
		ele.addEvent("focus", function(evt) { this.buttons.removeClass('hidden'); $('currentParamTab').value = this.getAttribute("id"); });
		ele.addEvent("blur", function(evt) { this.buttons.addClass('hidden'); });
	});
