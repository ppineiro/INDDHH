<%@page import="biz.statum.sdk.util.FileUtil"%><%@page import="biz.statum.sdk.util.StringUtil"%><%@ page import = "java.io.File"%><%@page import="java.io.FileInputStream"%><%@page import="com.st.util.labels.*"%><%@page import="biz.statum.apia.web.action.administration.HierarchicalStructureAction"%><%@page import="biz.statum.apia.web.bean.administration.HierarchicalStructureBean"%><%@page import="biz.statum.sdk.util.HttpServletRequestResponse"%><%
...
try {
	...
	HierarchicalStructureBean bean = HierarchicalStructureAction.staticRetrieveBean(http,false);
