...
%><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd"><html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><link href="<system:util show="context" />/css/<system:util show="currentStyle" />/dogmaErrorPage.css" rel="stylesheet" type="text/css" /></head><body><%if(Configuration.SERVER_MODE){ %><div class="divContent"><%=LabelManager.getName(labelSet,"msgDogmaErrorPageText") %></div><%}else{ %><div class="divContent"><div class="subTit">EXCEPTION</div><div class="section"><div class="dataTit">Apia Version:</div><div class="data"><%=com.dogma.DogmaConstants.APIA_VERSION%></div></div><% if (exception != null) { %><div class="section"><div class="dataTit">Exception:</div><div class="data"><%=exception.getClass().getName()%></div></div><%
					...
					%><% } else { %><div class="section"><div class="dataTit">Exception:</div><div class="data">No Exception</div></div><% } %><% if (rootException != null) { %><div class="section"><div class="dataTit">Root Exception:</div><div class="data"><%=rootException.getClass().getName()%></div></div><% } else { %><div class="section"><div class="dataTit">Root Exception:</div><div class="data">No Root Exception</div></div><% } %><div class="section"><div class="dataTit">URL:</div><div class="data"><%=request.getRequestURI().toString()%></div></div><div class="section"><div class="dataTit">Original URL:</div><div class="data"><%=request.getAttribute("apia.original.url")%></div></div><div class="section"><div class="dataTit">QueryString:</div><div class="data"><%=request.getQueryString()%></div></div><div class="section"><div class="dataTit">Type:</div><div class="data"><%if (request.getAttribute("CONTROLER") == null) {%>JSP<%} else {%>SUBMIT<%}%></div></div><% if (exception != null) { %><div class="section"><div class="dataTit">Message:</div><div class="data"><%=rootException==null?exception.getMessage():rootException.getMessage()%></div></div><div class="section"><div class="dataTit">Localized Message:</div><div class="data"><%=rootException==null?exception.getLocalizedMessage():rootException.getLocalizedMessage()%></div></div><% } else { %><div class="section"><div class="dataTit">Class:</div><div class="data">No Message</div></div><% } %><% if (rootException != null) {%><div class="subTit">ROOT CAUSE STACK TRACE</div><div class="stack"><%
