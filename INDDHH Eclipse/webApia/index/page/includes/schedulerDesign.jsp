<link href="<system:util show="context" />/css/<system:util show="currentStyle" />/tskSchedulerAdm.css" rel="stylesheet" type="text/css" ><script type="text/javascript" src="<system:util show="context" />/page/includes/scheduler.js"></script><script>
