...
<%
	...
	String url4 = helper.obtenerFuncionalidad(login, "Consulta expedientes por oficina", envId);
...
/*
#img7 span {
	background: transparent url('paneles/img/ConsultaPorContenido.png')	center 0;
}
*/
...
<script type="text/javascript">
	var urls = {
		...
		/*,
		7 : {
			title : "Consulta por contenido",
			url : "apia.query.UserAction.run?action=init&query=3539"
		}
		*/
	};
	...
	<div class="box categorias"
		...
		<div class="layout">
			<ul>
				...
				<%if (!url4.isEmpty()){%><li id='img4' onclick='loadURL(4)'><center><span></span> Consulta<br> por oficina</center></li>	<%}%>
