...
<%
	...
	String url1 = helper.obtenerFuncionalidad(login,
			"Crear forma documental", envId);
	String url2 = helper.obtenerFuncionalidad(login,
			"Bandeja de entrada", envId);
	String url3 = helper.obtenerFuncionalidad(login,
			"Gestionar ausencias", envId);
	String url4 = helper.obtenerFuncionalidad(login,
			"Consulta global por número de expediente", envId);
	String url5 = helper.obtenerFuncionalidad(login,
			"Consulta expedientes por fecha", envId);
	String url6 = helper.obtenerFuncionalidad(login,
			"Consulta de movimientos de expedientes", envId);
	String url7 = helper.obtenerFuncionalidad(login,
			"Expedientes en oficina", envId);
%>
