...
<%
	...
	environmentId = 1001;
	styleDirectory = EnvParameters.getEnvParameter(environmentId,EnvParameters.ENV_STYLE);//"default";
	langId = 1;
	...
	UserData uData2 = ThreadData.getUserData();
	//String nombreTitular =
	ApiaAbstractClass aac = (ApiaAbstractClass) uData2.getUserAttributes().get("aac");
