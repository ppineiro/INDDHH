...
function cargarMesasEntrada(flag){
	...
	// Enviamos la peticion	
	var URL = "<%=ConfigurationManager.getServerAddress(environmentId,currentLanguage) + Configuration.ROOT_PATH%>/expedientes/arbolOrganismoExternoARTEEDestino/cargarMesasEntrada.jsp?orgext=" + document.getElementById("organismoDestino").value + "&flag=" + flag;					
	//alert(URL);
