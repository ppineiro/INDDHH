		...
		//**cambia imagenes de Folder
  		...
  		if (eSrc.tp=='C'){
  			if (estado=="none" || estado==""){
				eSrc.childNodes(2).src="images/folder_closed.gif"					
  			}
  			else{					
  				eSrc.childNodes(2).src="images/folder_open.gif"					
  			}
  		}
  		
  		if (eSrc.tp=='PN'){
  			if (estado=="none" || estado==""){
				eSrc.childNodes(1).src="images/folder_closed.gif"					
  			}
  			else{					
  				eSrc.childNodes(1).src="images/folder_open.gif"					
  			}
  		}
