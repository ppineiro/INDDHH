...
function mostrarHistorial(nroExp) {	
	...
	var w =  ModalController.openWinModal(URL + TAB_ID_REQUEST, 1000, 546, null, null, null, true, false);
...
function verFoliado(nroExp,tarea) {	
	// SE ARMA URL			
	if (typeof(tarea) == 'undefined'){ nroExp = encodeBase64(nroExp); tarea = "TSKOtra"}
	URL = getUrlApp() + "/expedientes/descarga/controlDescarga.jsp?tipo=FOLIADO&nroExp=" + nroExp + "&tarea=" + tarea + TAB_ID_REQUEST;
...
function verCaratula(nroExp,tarea) {
	// SE ARMA URL
	if (typeof(tarea) == 'undefined'){ nroExp = encodeBase64(nroExp); }
...
function verFoliadoLeyAcceso(nroExp,tarea,nivelAcceso) {
	...
	/*
	window.status = URL;  	
	var w = window.open(URL,"Foliado","width=" + ancho + ",height=" + alto + ",top=" + posX + ",left=" + posY + ",scrollbars=YES,resizable=YES");
	w.focus();
	*/
...
function verHistCaratulas(nroExp) {
	...
	//var URL = "http://stw111:8280/ApiaExpedientes_INAU/DownloadServlet?tipo=FOLIADO&nroExp=" + nroExp;
	/*
	window.status = URL;  	
	var w = window.open(URL,"Caratula","width=" + ancho + ",height=" + alto + ",top=" + posX + ",left=" + posY + ",scrollbars=YES,resizable=YES");
	w.focus();
	*/
	var anchorDownloader = new Element('a', {
		href: URL,
...
function imprimirRemitoEmitirRemito(nroExp) {
	...
	//var URL = "http://stw111:8280/ApiaExpedientes_INAU/DownloadServlet?tipo=FOLIADO&nroExp=" + nroExp;
	window.status = URL;  	
	var w = window.open(URL,"Remito","width=" + ancho + ",height=" + alto + ",top=" + posX + ",left=" + posY + ",scrollbars=YES,resizable=YES");
	w.focus();
	*/
	var anchorDownloader = new Element('a', {
		href: URL,
