...
//String applet = "<center><applet id='signApplet' code='com.apia.sign.Sign.class' codebase='" + Parameters.ROOT_PATH + "/digitalSignatureApplet' archive='signedAppletFirma.jar' name='Firma Digital' width='400px' height='210px' > ";
...
//strApplet.append("archive='" + Parameters.ROOT_PATH + "/digitalSignatureApplet/signedAppletFirma.jar, " + Parameters.ROOT_PATH + "/digitalSignatureApplet/swing-layout-1.0.4.jar, " + Parameters.ROOT_PATH + "/digitalSignatureApplet/bcpkix-jdk15on-150.jar, " + Parameters.ROOT_PATH + "/digitalSignatureApplet/bcprov-ext-jdk15on-150.jar, " + Parameters.ROOT_PATH + "/digitalSignatureApplet/bcprov-jdk15-138.jar, " + Parameters.ROOT_PATH + "/digitalSignatureApplet/bcprov-jdk15on-150.jar, " + Parameters.ROOT_PATH + "/digitalSignatureApplet/commons-io-1.3.2.jar, " + Parameters.ROOT_PATH + "/digitalSignatureApplet/commons-io-1.3.2.jar, " + Parameters.ROOT_PATH + "/digitalSignatureApplet/itextpdf-5.4.3.jar' "); 
strApplet.append("archive='" + Parameters.ROOT_PATH + "/digitalSignatureApplet/signedAppletFirma.jar, " + Parameters.ROOT_PATH + "/digitalSignatureApplet/swing-layout-1.0.4.jar, " + Parameters.ROOT_PATH + "/digitalSignatureApplet/bcpkix-jdk15on-150.jar, " + Parameters.ROOT_PATH + "/digitalSignatureApplet/bcprov-ext-jdk15on-150.jar, " + Parameters.ROOT_PATH + "/digitalSignatureApplet/org.json-20120521.jar, " + Parameters.ROOT_PATH + "/digitalSignatureApplet/bcprov-jdk15on-150.jar, " + Parameters.ROOT_PATH + "/digitalSignatureApplet/commons-io-1.3.2.jar, " + Parameters.ROOT_PATH + "/digitalSignatureApplet/commons-io-1.3.2.jar, " + Parameters.ROOT_PATH + "/digitalSignatureApplet/itextpdf-5.4.3.jar' "); 
...
/* if (uData.getUserAttributes().get("TMP_NOMBRE_ARCHIVO_A_FIRMAR_1_STR") != null && uData.getUserAttributes().get("TMP_ARCHIVO_A_FIRMAR_1_STR") != null) 
	applet += "<param name='obj_id_0' value='"+ (String)uData.getUserAttributes().get("TMP_NOMBRE_ARCHIVO_A_FIRMAR_1_STR") +"'> <param name='hash_data_0' value='"+ (String)uData.getUserAttributes().get("TMP_ARCHIVO_A_FIRMAR_1_STR") +"'>";
	else
	applet += "<param name='obj_id_0' value=''> <param name='hash_data_0' value=''>";
 */
...
"<param name='dataReceptor'  value='expedientes/firma/guardarFirma.jsp?tabId=" + request.getParameter("tabId").toString() +"&tokenId="+ request.getParameter("tokenId").toString()+ "'>" +
...
/* "<param name='checkTime' value='/digitalSignatureApplet/checkClientTime.jsp'>" +
"<param name='checkTimeMSG' value='La hora de su máquina está desfazada con respecto a la del servidor.'>" +
 */
