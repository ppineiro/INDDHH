...
<head>
	...
	<link href="../../css/documentum/modal.css" rel="stylesheet" type="text/css">
	<link href="../../css/documentum/generalExecution.css" rel="stylesheet" type="text/css">
	...
	<script type="text/javascript">
		...
		var params = {
				...
				dataReceptor: "expedientes/firma/guardarFirmaChrome.jsp?<%				
					out.write("TMP_NRO_DOC_A_FIRMAR_STR=" + uData.getUserAttributes().get("TMP_NRO_DOC_A_FIRMAR_STR"));
				...
				lblCompTask: "<%=mensajeDao.obtenerMensajePorCodigo(Values.LBL_APPLET_COMP_TASK, 1,environmentId)%>",
				lblExit: "<%=mensajeDao.obtenerMensajePorCodigo(Values.LBL_APPLET_EXIT, 1,environmentId)%>",
		...
		function cofirmTask() {
			...
			frameElement.fireEvent('confirmTask');
		}
