...
<%
String param_score		= "0";
String param_titles		= "Muy malo; Malo; Regular; Bueno; Muy bueno";
String param_update		= "update";
String param_frmName	= "TRM_FRM_AYUDENOS_A_MEJORAR";
String param_attName	= "TRM_GESTION_CALIFICACION_NUM";
