...
function fnc_1001_1726(evtSource) { 
	
	var frmActual = "NOTA_OFICINA_DESTINO_";
	var frmName = "NOTA_OFICINA_DESTINO";
	...
	if (TIPO_PASE=="PASE_INTERNO"){
		...
		modal.onclose=function(){
			...
			if (sDestino == 'cancel' || sDestino == '' || sDestino == null){
				...
				document.getElementById(frmActual + "NTA_OFICINA_DESTINO_STR").setValue("");	
				document.getElementById(frmActual + "NTA_USUARIO_DESTINO_STR").setValue("");
				...
				document.getElementById(frmActual + "NTA_OFICINA_DESTINO_STR").setValue(vec[1]);			
				document.getElementById(frmActual + "NTA_USUARIO_DESTINO_STR").setValue(vec[2]);						
			}
		}
	}
