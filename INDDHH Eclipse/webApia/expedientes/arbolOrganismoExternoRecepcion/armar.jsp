...
function getModalReturnValue(modal) {		
	...
	if (destino == "" ){
	...
	}else if (document.getElementById("modoEnvio").value == 'ARTEE' && document.getElementById("textMesaDestino").value == ""){
		...
		if (document.getElementById("modoEnvio").value == 'ARTEE' && document.getElementById("textHayMEenOE").value == "0"){
			destino = "";
...
function busquedaOnKeyPress(){
	...
	if (document.getElementById("modoEnvio").value == "PAPEL"){
...
function displayEntOE(){
	...
	show('oPrimaryTOC2');
	hide('oPrimaryTOC');
	document.getElementById("modoEnvio").value = "PAPEL";	
...
function displayARTEE(){
	...
	show('oPrimaryTOC');
	hide('oPrimaryTOC2');
	document.getElementById("modoEnvio").value = "ARTEE";
...
<BODY onLoad="whenLoad()">
	<form name="frmMain" id="frmMain" method="post">
		...
		<input id=modoEnvio name=modoEnvio type="hidden" value="ARTEE">
		<%} else { %>
		<input id=modoEnvio name=modoEnvio type="hidden" value="PAPEL">		
		<%} %>
...
<table border=0>
<tr style="HEIGHT:15%">
<td colspan =2><font style="FONT-FAMILY: verdana; FONT-SIZE: 8pt;"><legend><%=mensajeDao.obtenerMensajePorCodigo("VAL_LBL_BUSCAR_ORGANISMO_JSP_TXT", currentLanguage, environmentId)%></legend> <input type=text id='busqueda' onkeyup='return busquedaOnKeyPress();'></font>
</td>
</tr>
<tr style="HEIGHT:70%">
	<td>
		...
		<fieldset id="treefield" name="treefield" style="display:none"> <!-- ; HEIGHT: 287px; WIDTH: 300px -->
			<legend><font style="FONT-FAMILY: verdana; FONT-SIZE: 8pt;"><%=mensajeDao.obtenerMensajePorCodigo("VAL_LBL_SELECCIONAR_ORGANISMO_EXTERNO_JSP_TXT", currentLanguage, environmentId)%></font></legend>
			<BLOCKQUOTE CLASS="body">
				<DIV id="oTocDiv" style="BACKGROUND-COLOR: <%=Mensajes.com_st_apia_expedientes_style_arbol_destino%>; BORDER-BOTTOM: #505050 1px solid; BORDER-LEFT: #505050 1px solid; BORDER-RIGHT: #505050 1px solid; BORDER-TOP: #505050 1px solid; FONT-FAMILY: verdana; FONT-SIZE: 8pt; HEIGHT: 238px; OVERFLOW: auto; WIDTH: 441px">
