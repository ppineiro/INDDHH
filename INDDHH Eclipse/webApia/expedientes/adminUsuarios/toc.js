...
//	tmpName = replaceSubstring(tmpName, sep2 + ele.parentNode.title + sep2, sep2);
	...
	document.getElementById("textIdOficinaDestino").value = ele.value;//tmpId;
	document.getElementById("textCodOficinaDestino").value = ele.name;//tmpCod;
	document.getElementById("textNameOficinaDestino").value = ele.parentNode.title;//tmpName;		
