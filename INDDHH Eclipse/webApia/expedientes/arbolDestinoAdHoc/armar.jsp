...
function cargarUsuarios(flag){
	...
	var URL = "<%=ConfigurationManager.getServerAddress(environmentId,currentLanguage) + Configuration.ROOT_PATH%>/expedientes/arbolDestinoAdHoc/cargarUsuarios.jsp?unidad=" + document.getElementById("textIdOficinaDestino").value + "&flag=" + flag + "&envId=" + <%=environmentId%>;					
	//alert(URL);
...
function fnFlash(oTitle){
	...
	<style type="text/css">
		...
		#treefieldusr {     HEIGHT: 287px; WIDTH: 225px; position: relative; left: 33%; }
		#usrImg { position: relative; left: 55%; HEIGHT: 287px; WIDTH: 150px; }
		...
		#oPrimaryTOCUsr { position: relative; left: -20%; top: -7%; width: 195px; }
	</style>
