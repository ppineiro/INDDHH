...
function desChequearUsuarios(ele){	
	...
	document.getElementById("textOficinaDestino").value =  document.getElementById("NAME_OF_" + ele.value).value;
	document.getElementById("textNombOficinaDestino").value =  document.getElementById("DESC_OF_" + ele.value).value;
