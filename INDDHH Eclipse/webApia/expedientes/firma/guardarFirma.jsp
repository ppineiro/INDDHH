...
<%
	...
	try {
		...
		System.out.println(request.getParameter("tabId"));
		System.out.println(request.getParameter("tokenId"));

		int environmentId = ThreadData.getUserData().getEnvironmentId();//Integer.parseInt(request.getParameter("envId"));
		System.out.println("2");
		String usrClave	= ThreadData.getUserData().getUserId();//request.getParameter("userId").toString();
		System.out.println("3");
		String tokenId	= ThreadData.getUserData().getTokenId(); //.getParameter("uTokenID").toString();
		System.out.println("4");
		String sessionId	= ThreadData.getUserData().getSessionId();//.getParameter("sessionId").toString();
		System.out.println("5");
		String nroDocFirmar = ThreadData.getUserData().getUserAttributes().get("TMP_NRO_DOC_A_FIRMAR_STR").toString();//request.getParameter("nroDocFirmar").toString();
		System.out.println("6");
		String envName		= ThreadData.getUserData().getEnvironmentName();//request.getParameter("envName").toString();
		System.out.println("7");
		String carVersion	= ThreadData.getUserData().getUserAttributes().get("VERSION_CARATULA_RELACIONADA").toString();//request.getParameter("carVersion").toString();
		System.out.println("8");
		String jefaturaP	= ThreadData.getUserData().getUserAttributes().get("JEFATURA").toString();//request.getParameter("jefatura").toString();
		System.out.println("9");

		// EJECUCIÓN DE LA FIRMA
		UserData uData = ThreadData.getUserData();
	    Boolean deshabilitada = ControlSesionesUsuario.controlarClaseEstaDeshabilitada(environmentId);
		...
		if(!deshabilitada){			
			...
			if(ok){		
				...
				Integer envId = environmentId;
				System.out.println("********************************* 7");
				
				String pkcs7 = request.getParameter("pkcs7").toString();
				System.out.println("********************************* 8");
				
				String nroDocumento = nroDocFirmar;
				System.out.println("********************************* 9");
				
				String env_name = envName;
				System.out.println("********************************* 10");
				
				String versionCaratula = carVersion;
				...
				if (nroDocumento.contains(";")) {
					...
					for (int i = 0; i < nrosExp.length ; i++) {
						if (nombre.contains(nrosExp[i])) {
							String usuario = usrClave;
							String jefatura = jefaturaP;
