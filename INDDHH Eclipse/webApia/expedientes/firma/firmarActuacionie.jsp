...
<% 		
	...
	if (uData!=null){	
		if (uData.getUserAttributes().get("APPLET_SRC_IE")!=null){
			htmlData = (String)uData.getUserAttributes().get("APPLET_SRC_IE");		
			htmlData = htmlData.replace("<TOK_S_ID>", request.getSession().getId());
			System.out.println( "APPLET_SRC_IE: " + htmlData ); 	
