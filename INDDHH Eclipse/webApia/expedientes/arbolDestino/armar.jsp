		...
		<table border="0" width="100%">
			<tr>
				<td colspan=2>
					...
					<button onclick='return buscarNodo("ant");'><%=mensajeDao.obtenerMensajePorCodigo("VAL_LBL_ANTERIOR_BUSQUEDA_JSP_TXT", currentLanguage,environmentId)%></button></font>
				</td>
			</tr>
			<tr>
				<td>
					<div id="tree" onclick="treeClick(event)">
						<fieldset id="treefield" name="treefield">
							<legend>
								<font style="FONT-FAMILY: verdana; FONT-SIZE: 8pt;">
								<%=mensajeDao.obtenerMensajePorCodigo("VAL_LBL_SELECCIONAR_OFICINA_JSP_TXT", currentLanguage,environmentId)%>
								</font>
							</legend>
				...
				<td>
					<fieldset id="treefieldusr" name="treefieldusr">
						<legend>
							<font style="FONT-FAMILY: verdana; FONT-SIZE: 8pt;"><%=mensajeDao.obtenerMensajePorCodigo("VAL_LBL_USUARIO_DESTINO_JSP_TXT", currentLanguage,	environmentId)%></font>
						</legend>
						<DIV id="oTocDivUsr">
				...
				<td>
					<fieldset id="usrImg" name="usrImg">
						<legend>
							<font style="FONT-FAMILY: verdana; FONT-SIZE: 8pt;"><%=mensajeDao.obtenerMensajePorCodigo("VAL_LBL_FOTO_JSP_TXT", currentLanguage, environmentId)%></font>
						</legend>
