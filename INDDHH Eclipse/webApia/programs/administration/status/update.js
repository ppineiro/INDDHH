	...
	if (verifyRequiredObjects()) {
		if(isValidName(document.getElementById("txtName").value)){
			if (verifyPermissions()){
				document.getElementById("frmMain").action = "administration.EntitiesStatusAction.do?action=confirm";
...
function loadProyectPerms(){
	...
	var sXMLSourceUrl = "administration.EntitiesStatusAction.do?action=getProjPermssions&prjId=" + prjId;
