	...
	if (verifyRequiredObjects()) {
		if(isValidName(document.getElementById("txtName").value)){
			if (verifyPermissions()){
				document.getElementById("frmMain").action = "administration.ClasificationsAction.do?action=confirm";
...
function loadProyectPerms(){
	...
	var sXMLSourceUrl = "administration.ClasificationsAction.do?action=getProjPermssions&prjId=" + prjId;
