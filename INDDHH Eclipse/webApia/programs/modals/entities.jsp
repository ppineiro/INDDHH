...
function doXMLLoad(){
	var sXMLSourceUrl = "entitiesXML.jsp?name=" + escape(document.getElementById("txtNom").value) + "&envId=<%=request.getParameter("envId")%>";
		...
		if (xmlRoot.childNodes.length == 0) {
			...
			for(i=0;i<xmlRoot.childNodes.length;i++){
				if (i >= <%=Parameters.MAX_RESULT_MODAL %>) {
					...
					oTd0.entityId = xRow.childNodes[0].firstChild.nodeValue;
					oTd0.entityName = xRow.childNodes[1].firstChild.nodeValue;
