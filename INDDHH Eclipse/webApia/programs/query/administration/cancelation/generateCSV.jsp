<%@page import="biz.statum.sdk.util.StringUtil"%><%@page import="com.dogma.util.DownloadUtil"%><%@page import="com.dogma.vo.*"%><%@page import="com.dogma.*"%><%@page import="java.util.*"%><%@page import="com.dogma.Parameters"%><jsp:useBean id="qBean" scope="session" class="com.dogma.bean.query.QryProCancelBean"></jsp:useBean><%
...
response.setHeader("Content-Disposition", "attachment; filename=\"" + filName + ".csv\"");
