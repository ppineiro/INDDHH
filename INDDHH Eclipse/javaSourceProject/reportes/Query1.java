...
public class Query1 extends QueryAbstractClass {
	...
	protected void executeQuery(Query qry) throws BusClassException {
		...
		try {
			...
			String query =	
					"(SELECT 'No admisible' as tipo_int, count(*) as ctd" + 
					...
					"union all" + 
					"  (SELECT 'Admisible - Denuncia' as tipo_int," + 
					"    (select count(*)" + 
					"" + 
					...
					"union all" + 
					"  (SELECT 'Admisible - Coordinar con otro organismo' as tipo_int," + 
					"    (select count(*)" + 
					"" + 
					"    from bus_ent_inst_attribute ent_att" + 
					"      join attribute att on ent_att.att_id = att.att_id_auto and ent_att.env_id = att.env_id" + 
					...
					"union all" + 
					"  (SELECT 'Cantidad total' as tipo_int, count(*) as ctd" + 
					"" + 
					"  from bus_ent_instance bei" + 
					"" + 
					"  where bei.env_id = 1" + 
