...
public class Query6 extends QueryAbstractClass {
	...
	protected void executeQuery(Query qry) throws BusClassException {
		...
		try {
			...
			String query =	
					...
					" " + 
					"            and att.att_name = 'INDDHH_PERSONA_GENERO_STR' " + 
