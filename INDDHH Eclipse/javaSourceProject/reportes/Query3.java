...
public class Query3 extends QueryAbstractClass {
	...
	protected void executeQuery(Query qry) throws BusClassException {
		...
		try {
			...
			String query =	
					"(SELECT 'Comisionado Parlamentario Penitenciario' as org, " + 
					"        (select count(*) " + 
					" " + 
					...
					" " + 
					"            and att.att_name = 'INDDHH_ORGANISMO_COORDINAR_STR' " + 
					...
					" " + 
					"union all " + 
					"    (SELECT 'Total de denuncias coordinadas' as org, " + 
					"        (select count(*) " + 
					" " + 
					"        from bus_ent_inst_attribute ent_att " + 
					"            join attribute att on ent_att.att_id = att.att_id_auto and ent_att.env_id = att.env_id " + 
