...
public class Query5 extends QueryAbstractClass {
	...
	protected void executeQuery(Query qry) throws BusClassException {
		...
		try {
			...
			String query =	
				"(SELECT 'Persona individual' as persona, " + 
				"		(select count(*) " + 
				" " + 
				...
				" " + 
				"			and att.att_name = 'INDDHH_TIPO_PERSONA_STR' " + 
				...
				" " + 
				"union all " + 
				"	(SELECT 'Colectiva (varias personas individuales)' as persona, " + 
				"		(select count(*) " + 
				" " + 
				"		from bus_ent_inst_attribute ent_att " + 
				"			join attribute att on ent_att.att_id = att.att_id_auto and ent_att.env_id = att.env_id " + 
				...
				" " + 
				"union all " + 
				"	(SELECT 'Organismo del Estado' as persona, " + 
				"		(select count(*) " + 
				" " + 
				"		from bus_ent_inst_attribute ent_att " + 
				"			join attribute att on ent_att.att_id = att.att_id_auto and ent_att.env_id = att.env_id " + 
				...
				" " + 
				"union all " + 
				"	(SELECT 'Organismo Internacional' as persona, " + 
				"		(select count(*) " + 
				" " + 
				"		from bus_ent_inst_attribute ent_att " + 
				"			join attribute att on ent_att.att_id = att.att_id_auto and ent_att.env_id = att.env_id " + 
				...
				"			and att.att_name = 'INDDHH_TIPO_PERSONA_STR' " + 
				"			and bei.bus_ent_id = 1379 " + 
				"			and ent_att.ent_inst_att_str_value = '6' " + 
				"			and bei.env_id = 1 and ent_att.env_id = 1 "
				+ "and bei.bus_ent_inst_create_data >= timestamp '" + fechaInicioStr + "' "
				+ "and bei.bus_ent_inst_create_data <= timestamp '" + fechaFinStr + "' " + ") as ctd" + 
				") " + 
