...
public class GenerarYEnviarTickets extends ApiaAbstractClass {
	...
	protected void executeClass() throws BusClassException {
		...
		// Obtenci�n de valores de atributos
		...
		// Determinar nombre de organizaci�n (Persona/Organizaci�n)
		if (pertenenciaInst.compareTo("1") == 0) {
			// S� pertenece a instituci�n
		...
		if (pertenenciaInst.compareTo("1") == 0) {
			if ((tipoInst.compareTo("1") == 0 && instRegistrada.compareTo("1") == 0)
				...
				// S� pertenece a instituci�n y est� registrada, o es org. del estado
	...
	private static File crearTicket(String ubicacionAGuardar, String nroDocumento, String nombreCompleto,
		...
		Chunk tlOrganizacion = new Chunk("ORGANIZACI�N", FontFactory.getFont("Arial", 16, Font.BOLD));
